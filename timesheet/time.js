$(document).ready(function() {
    ...
    $('.dt-add').each(function () {
        $(this).on('click', function(evt){
            ...
            rowData.push('<div class="col-md-3 col-lg-3">\n                    <button class="btn btn-lg btn-default dropdown-toggle form-dontrol"\n                            type="button" data-toggle="dropdown" aria-expanded="false">\n                        Select Project and Task <span class="caret"></span>\n                    </button>\n                    <ul class="dropdown-menu" role="menu">\n                    </ul>\n                </div>');
            //Some description
            rowData.push('<div class="col-md-1 col-lg-1">\n                    <input type="text" class="form-control"  aria-label="..." style="width: 50px;">\n                </div>');
            //Random date
            ...
            rowData.push('<button type="button" class="btn btn-danger btn-xs dt-delete"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>');
